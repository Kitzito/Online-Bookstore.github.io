            ...
            <!-------Products CRUD Section Start------->
                ...
                <section class="add-products">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" name="image" accept="image/jpg, image/png, image/jpeg, image/webp, .zip,.rar,.7z,.gz,.pdf" class="box" required>
            ...
            <section class = "edit-product-form">
                ...
                ?>
                    <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="file" class="box" name="update_image" accept="image/jpg, image/png, image/jpeg, image/webp, .zip,.rar,.7z,.gz,.pdf" >
