...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="https://www.github.com/Kitzito.git"> <i class="fab fa-github"></i> Github </a>
    ...
    <p class="credit"> Created with <i class="fa fa-heart"></i> by <span> Bill'sUpdate </span> @ <?php echo date('Y'); ?> | 
